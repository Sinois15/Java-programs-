...
public class Shop{
    ...
    public Shop(){
        ...
        inv.add(new Item("Corn Seed", 1.95, 1, 10, 13)); //Item ID 1
        inv.add(new Item("Potato Seed", 1.20, 2, 6, 9)); //Item ID 2
        inv.add(new Item("Lettuce seed", 1.60, 3, 8, 10));//Item ID 3
        ...
        inv.add(new Item("Corn", 3.00, 7)); //Item ID 7
        inv.add(new Item("Potato", 4.00, 8)); //Item ID 8
        inv.add(new Item("Lettuce", 5.00, 9)); //Item ID 9
